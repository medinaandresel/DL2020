...
public class GenRAtom extends GenAtom{
	private String roleName;
	private String var1Name;
	private String var2Name;
	public GenRAtom(String roleName, String var1Name, String var2Name) {
		super();
	...
	public String toDatalog(String tau) {
		...
		String facts = DatalogBuiltIns.gen+"("+ tau + "," + roleName +","+ DatalogBuiltIns.varPrefix+var1Name+","+DatalogBuiltIns.varPrefix+var2Name+ "). \n";
		 facts += DatalogBuiltIns.role+"("+roleName+") . \n "+DatalogBuiltIns.adom+"("+roleName+") . \n";
		return facts;		
	}
	
	public static GenRAtom parseExpression(String expression) throws ParseError {
		int pos1 = expression.indexOf("GEN");
		int pos2 = expression.indexOf("{");
		if (pos1==-1 || pos2==-1)
		{
			throw new ParseError("GenRAtom: not a specialising atom");
		}
		
		int pos3 = expression.indexOf("}");
		if (pos3==-1)
		{
			throw new ParseError("GenRAtom: not matching { } ")  ;
		}
		...
		if (pos4==-1 ||  pos5==-1)
		{
			throw new ParseError("GenRAtom: not matching paranthesis");
		}
	...
	public String toString() {
		return "GenRAtom [roleName=" + roleName + ", var1Name=" + var1Name + ", var2Name=" + var2Name + "]\n";
	}
